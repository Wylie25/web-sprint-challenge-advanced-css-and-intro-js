...
function changeValue(obj, keytochange, newvalue) {
  obj[keytochange] = newvalue;
}

changeValue(artists[8], "name", "Vincent Van Gogh");
console.log(artists);
 ...
 * it will remove Amedeo Modigliani from our dataset and log the number 1
 *
